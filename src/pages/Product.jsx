...
const Products = () => {
  const { products, addOrUpdateProduct, deleteProduct } = useProduct();
  const { categories } = useCategory();
  ...
  return (
    <>
      ...
      <div className="w-full overflow-x-auto">
        <table className="min-w-[900px] w-full bg-white rounded table-fixed">
          <thead className="bg-gray-100">
            <tr>
              <th className="px-4 py-2 text-left w-16">Image</th>
              <th className="px-4 py-2 text-left">Name</th>
          ...
          <tbody>
            {products.map((p) => (
              <tr key={p.id} className="border-t">
                ...
                <td className="px-4 py-2 text-center">S, M, L</td>
                <td className="px-4 py-2">
                  {p.orderType?.join(", ")}
                </td>
                <td className="px-4 py-2">
